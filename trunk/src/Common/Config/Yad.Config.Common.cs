...
// Creation Date: 2007-11-08 16:46:51
//--------------------------------------------------------------
...
namespace Yad.Config.Common
{
	...
	{
		public Yad.Config.Common.BuildingsNames Add(Yad.Config.Common.BuildingsNames obj)
		{
			base.Add(obj);
			return obj;
		}

		public Yad.Config.Common.BuildingsNames Add()
		{
			return Add(new Yad.Config.Common.BuildingsNames());
		}

		public void Insert(int index, Yad.Config.Common.BuildingsNames obj)
		{
			base.Insert(index, obj);
		}

		public void Remove(Yad.Config.Common.BuildingsNames obj)
		{
			base.Remove(obj);
		}

		new public Yad.Config.Common.BuildingsNames this[int index]
		{
			get { return (Yad.Config.Common.BuildingsNames) base[index]; }
			set { base[index] = value; }
		}
	}

...
// Creation Date: 2007-11-26 23:00:42
//--------------------------------------------------------------
...
namespace Yad.Config.Common
{
	...
	public class BuildingData
	{
		...
		[XmlElement(ElementName="AmmoDamageRange",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="string",Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public string __AmmoDamageRange;
		
		[XmlIgnore]
		public string AmmoDamageRange
		{ 
			get { return __AmmoDamageRange; }
			set { __AmmoDamageRange = value; }
		}

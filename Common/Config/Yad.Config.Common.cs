...
// Creation Date: 2007-12-16 19:39:01
//--------------------------------------------------------------
...
namespace Yad.Config.Common
{
	...
	public class UnitTrooperData
	{
		...
		[XmlElement(ElementName="AmmoDamageRange",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="short",Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public short __AmmoDamageRange;
		
		[XmlIgnore]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public bool __AmmoDamageRangeSpecified;
		
		[XmlIgnore]
		public short AmmoDamageRange
		{ 
			get { return __AmmoDamageRange; }
			set { __AmmoDamageRange = value; __AmmoDamageRangeSpecified = true; }
		}
		...
		[XmlElement(ElementName="Size",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="float",Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public float __Size;
		...
		[XmlElement(Type=typeof(Yad.Config.Common.BuildingsNames),ElementName="BuildingDependency",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public Yad.Config.Common.BuildingsNames __BuildingDependency;
		
		[XmlIgnore]
		public Yad.Config.Common.BuildingsNames BuildingDependency
		{
			get
			{
				if (__BuildingDependency == null) __BuildingDependency = new Yad.Config.Common.BuildingsNames();		
				return __BuildingDependency;
			}
			set {__BuildingDependency = value;}
		}
	...
	public class BuildingData
	{
		...
		[XmlElement(ElementName="IsRefinery",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="boolean",Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public bool __IsRefinery;
		
		[XmlIgnore]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public bool __IsRefinerySpecified;
		
		[XmlIgnore]
		public bool IsRefinery
		{ 
			get { return __IsRefinery; }
			set { __IsRefinery = value; __IsRefinerySpecified = true; }
		}

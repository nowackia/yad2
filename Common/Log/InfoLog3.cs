...
namespace Yad.Log.Common {
    ...
    public class InfoLog3 {
        ...
        /// Nazwa pliku logu
        /// </summary>
        public const string ErrorLogFilename = "ErrorLog3.txt";
        ...
        /// Singleton logu
        /// </summary>
        private static InfoLog3 _infoLog = null;
        ...
        private InfoLog3(MultiStream writer) {
            _writer = writer;
        ...
        /// Instancja inflogu
        /// </summary>
        public static InfoLog3 Instance {
            get {
                if (null == _infoLog) {
                    _infoLog = new InfoLog3(GetWriter());
                    return _infoLog;
                }
                return _infoLog;
            }
        ...
        public static void WriteStart() {
            InfoLog3.Write("____________________________________________");
            InfoLog3.Write("Application BEGIN " +
                Assembly.GetExecutingAssembly().GetName().ToString() + " : "
                + Assembly.GetExecutingAssembly().GetName().Version.ToString());
        }

        public static void WriteEnd() {
            InfoLog3.Write("Application END");
            InfoLog3.Write("^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^");
        }
